...
ec2_f21_Beta_Base = [
						{'region':'US East (Northern Virginia)', 'arch':'x86_64', 'store':'EBS-Backed', 'id':'ami-fa3dbf92'},
#                        {'region':'US East (Northern Virginia)', 'arch':'i386', 'store':'EBS-Backed', 'id':'ami-8b4219e2'},
						{'region':'Asia Pacific (Singapore)', 'arch':'x86_64', 'store':'EBS-Backed', 'id':'ami-2ecfef7c'},
#                        {'region':'Asia Pacific (Singapore)', 'arch':'i386', 'store':'EBS-Backed', 'id':'ami-0eb2e75c'},
						{'region':'Asia Pacific (Sydney)', 'arch':'x86_64', 'store':'EBS-Backed', 'id':'ami-aff99595'},
#                        {'region':'Asia Pacific (Sydney)', 'arch':'i386', 'store':'EBS-Backed', 'id':'ami-db63ffe1'},
						{'region':'Asia Pacific (Tokyo)', 'arch':'x86_64', 'store':'EBS-Backed', 'id':'ami-8d93ae8c'},
#                        {'region':'Asia Pacific (Tokyo)', 'arch':'i386', 'store':'EBS-Backed', 'id':'ami-e15135e0'},
						{'region':'US West (Northern California)', 'arch':'x86_64', 'store':'EBS-Backed', 'id':'ami-21465164'},
#                        {'region':'US West (Northern California)', 'arch':'i386', 'store':'EBS-Backed', 'id':'ami-00d0e645'},
						{'region':'US West (Oregon)', 'arch':'x86_64', 'store':'EBS-Backed', 'id':'ami-1da3ea2d'},
#                        {'region':'US West (Oregon)', 'arch':'i386', 'store':'EBS-Backed', 'id':'ami-48ca5178'},
						{'region':'EU (Ireland)', 'arch':'x86_64', 'store':'EBS-Backed', 'id':'ami-66c76c11'},
#                        {'region':'EU (Ireland)', 'arch':'i386', 'store':'EBS-Backed', 'id':'ami-897b99fe'},
						{'region':'EU (Frankfurt)', 'arch':'x86_64', 'store':'EBS-Backed', 'id':'ami-e0c7f1fd'},
#                        {'region':'EU (Frankfurt)', 'arch':'i386', 'store':'EBS-Backed', 'id':'ami-897b99fe'},
						{'region':'South America (Sao Paulo)', 'arch':'x86_64', 'store':'EBS-Backed', 'id':'ami-5f6fd842'}
#                        {'region':'South America (Sao Paulo)', 'arch':'i386', 'store':'EBS-Backed', 'id':'ami-4b5cfa56'}
]

ec2_f21_Beta_Atomic = [
						{'region':'Asia Pacific (Tokyo)', 'arch':'x86_64', 'store':'BS-Backed', 'id':'ami-81dbe480'},
						{'region':'Asia Pacific (Singapore)', 'arch':'x86_64', 'store':'BS-Backed', 'id':'ami-f64764a4'},
						{'region':'Asia Pacific (Sydney)', 'arch':'x86_64', 'store':'BS-Backed', 'id':'ami-6516795f'},
						{'region':'EU (Ireland)', 'arch':'x86_64', 'store':'BS-Backed', 'id':'ami-e66dc791'},
						{'region':'EU (Frankfurt)', 'arch':'x86_64', 'store':'BS-Backed', 'id':'ami-4ccef851'},
						{'region':'South America (Sao Paulo)', 'arch':'x86_64', 'store':'BS-Backed', 'id':'ami-e118affc'},
						{'region':'US East (Northern Virginia)', 'arch':'x86_64', 'store':'BS-Backed', 'id':'ami-1ecb4576'},
						{'region':'US West (Northern California)', 'arch':'x86_64', 'store':'BS-Backed', 'id':'ami-b3f3e4f6'},
						{'region':'US West (Oregon)', 'arch':'x86_64', 'store':'BS-Backed', 'id':'ami-39763e09'}
]
...
#						{'region':'EU (Frankfurt)', 'arch':'x86_64', 'store':'BS-Backed', 'id':'ami-a5ad56d2'},
...
#						{'region':'EU (Frankfurt)', 'arch':'i386', 'store':'BS-Backed', 'id':'ami-0bac577c'},
...
#						{'region':'EU (Frankfurt)', 'arch':'i386', 'store':'BS-Backed', 'id':'ami-e7a25990'},
...
#						{'region':'EU (Frankfurt)', 'arch':'x86_64', 'store':'BS-Backed', 'id':'ami-29a2595e'},
...
def get_amis():
	ec2_f21_Beta_Base_regions = sorted_region(ec2_f21_Beta_Base)
	ec2_f21_Beta_Atomic_regions = sorted_region(ec2_f21_Beta_Atomic)
	...
	if not os.path.exists(OUTPUT):
		gen_js(
			['20',ec2_f20],
			['19',ec2_f19],
			['21_Beta_Base',ec2_f21_Beta_Base],
			['21_Beta_Atomic',ec2_f21_Beta_Atomic])

	return {
		'f20':ec2_f20, 'f20_regions':ec2_f20_regions,
		'f19':ec2_f19, 'f19_regions':ec2_f19_regions,
		'f21_Beta_Base':ec2_f21_Beta_Base, 'f21_Beta_Base_regions':ec2_f21_Beta_Base_regions,
		'f21_Beta_Atomic':ec2_f21_Beta_Atomic, 'f21_Beta_Atomic_regions':ec2_f21_Beta_Atomic_regions
		   }
