...
$(document).ready(function(){
    ...
    // redirect download links to KDE splash page
    $("a.kde-download-splash").click(function(event){
        event.preventDefault();
        linkLocation = this.href;

        // this passes the URL path to the KDE splash page
        window.location = 'kde-download-splash?file='+linkLocation;
    });

    // redirect download links to Xfce splash page
    $("a.xfce-download-splash").click(function(event){
        event.preventDefault();
        linkLocation = this.href;

        // this passes the URL path to the Xfce splash page
        window.location = 'xfce-download-splash?file='+linkLocation;
    });

    // redirect download links to LXDE splash page
    $("a.lxde-download-splash").click(function(event){
        event.preventDefault();
        linkLocation = this.href;

        // this passes the URL path to the LXDE splash page
    ...
    $("a.mate-compiz-download-splash").click(function(event){
        ...
        // this passes the URL path to the MATE Compiz splash page
        window.location = 'mate-compiz-download-splash?file='+linkLocation;
    });

    // redirect download links to SoaS splash page
    $("a.soas-download-splash").click(function(event){
        event.preventDefault();
        linkLocation = this.href;

        // this passes the URL path to the SoaS splash page
        window.location = 'soas-download-splash?file='+linkLocation;
    });

    // redirect download links to Cinnamon splash page
    $("a.cinnamon-download-splash").click(function(event){
        event.preventDefault();
        linkLocation = this.href;

        // this passes the URL path to the SoaS splash page
        window.location = 'cinnamon-download-splash?file='+linkLocation;
    });
