...
checksums['Fedora-Live-Workstation-x86_64-' + curr_id + '-' + RC_gold + '.iso'] = dir_path + 'Fedora-Workstation-' + curr_id + '-x86_64-CHECKSUM';
checksums['Fedora-Workstation-netinst-x86_64-' + curr_id + '.iso'] = dir_path + 'Fedora-Workstation-' + curr_id + '-x86_64-CHECKSUM';
checksums['Fedora-Live-Workstation-i686-' + curr_id + '-' + RC_gold + '.iso'] = dir_path + 'Fedora-Workstation-' + curr_id + '-i386-CHECKSUM';
checksums['Fedora-Workstation-netinst-i386-' + curr_id + '.iso'] = dir_path + 'Fedora-Workstation-' + curr_id + '-i386-CHECKSUM';
...
checksums['Fedora-Cloud-Base-' + curr_id + '-' + composedate + '.x86_64.qcow2'] = dir_path + 'Fedora-Cloud_Images-x86_64-' + curr_id + '-CHECKSUM';
checksums['Fedora-Cloud-Base-' + curr_id + '-' + composedate + '.x86_64.raw.xz'] = dir_path + 'Fedora-Cloud_Images-x86_64-' + curr_id + '-CHECKSUM';
checksums['Fedora-Cloud-Base-Vagrant-' + curr_id + '-' + composedate + '.x86_64.vagrant-libvirt.box'] = dir_path + 'Fedora-Cloud_Images-x86_64-' + curr_id + '-CHECKSUM';
checksums['Fedora-Cloud-Base-Vagrant-' + curr_id + '-' + composedate + '.x86_64.vagrant-virtualbox.box'] = dir_path + 'Fedora-Cloud_Images-x86_64-' + curr_id + '-CHECKSUM';
checksums['Fedora-Cloud-Base-' + curr_id + '-' + composedate + '.i386.qcow2'] = dir_path + 'Fedora-Cloud_Images-i386-' + curr_id + '-CHECKSUM';
checksums['Fedora-Cloud-Base-' + curr_id + '-' + composedate + '.i386.raw.xz'] = dir_path + 'Fedora-Cloud_Images-i386-' + curr_id + '-CHECKSUM';
checksums['Fedora-Docker-Base-' + curr_id + '-' + composedate + '.x86_64.tar.xz'] = dir_path + 'Fedora-Docker-x86_64-' + curr_id + '-CHECKSUM';
