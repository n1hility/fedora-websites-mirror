...
def collect(release):
    ...
    templates = [
        ...
        #("Fedora-Cloud-Base-{next_cloud_AMI_id}_{curr_cloud_AMI_state}-{pre_cloud_AMI_composedate}.x86_64", {
        ...
        #}),
        #("Fedora-Cloud-Atomic-{next_cloud_AMI_id}_{curr_cloud_AMI_state}-{pre_cloud_AMI_atomic_composedate}.x86_64", {
